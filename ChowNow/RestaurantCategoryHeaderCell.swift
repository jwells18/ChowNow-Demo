//
//  RestaurantCategoryHeaderCell.swift
//  ChowNow
//
...
class RestaurantCategoryHeaderCell: UICollectionViewCell{
    ...
    func setupConstraints(){
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[headerLabel]|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
