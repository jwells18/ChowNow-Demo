...
class FiltersTableHeader: UIView{
    ...
    func setupConstraints(){
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[headerLabel]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
