...
protocol MainListRestaurantCellDelegate {
    func didPressEmptyButton()
}

class MainListRestaurantCell: UITableViewCell{
    
    var mainListRestaurantCellDelegate: MainListRestaurantCellDelegate!
    var nameLabel = UILabel()
    var categoryLabel = UILabel()
    var statusLabel = UILabel()
    var locationLabel = UILabel()
    var downloadingActivityView = UIActivityIndicatorView()
    var emptyView = MainListRestaurantCellEmptyView()
    ...
    func setupConstraints(){
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-[nameLabel]-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-[statusLabel]-[locationLabel]-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
    ...
    func emptySearchButtonPressed(){
        mainListRestaurantCellDelegate.didPressEmptyButton()
    }
}
